...
\begin{document}
	...
	\begin{frame}{Dataset}
		Fetched from \link{https://www.kaggle.com/datasets/dataclusterlabs/indian-vehicle-dataset}{Kaggle} and CICET camera network. Used labelImg to label images. 
		\begin{center}
			\begin{table}
	...
	\begin{frame}{Dataset - Camera Network}
		\begin{figure}
