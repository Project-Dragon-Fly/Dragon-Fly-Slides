...
\begin{frame}{Motivation}
	Current system make use of manual approach of reviewing long video clips to identify the suspect vehicle. Various possible routes that can be taken by suspect further makes the process of re-identification very difficult and time consuming.\\~\\
		
	There do not exist an approachable system where user can interact via simple textual description to lookup suspect vehicles.\\~\\
				
	Traffic flow analysis can aid in Anomaly detection, Alert Control System, \& emergency services.		
\end{frame}
...
\begin{frame}{Objective}
	\begin{itemize}
		...
		\item Conduct traffic analysis to predict traffic flow
