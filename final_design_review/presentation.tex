...
\begin{table}[!h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|}
			...
			\begin{tabular}[c]{@{}l@{}}Pros:\\ Superior processing speed \& \\ recognition accurancy wrt existing \\ VMMR, Accounts for partial \\ viewpoints\\ \\ Cons:\\ High dimensionality,  Region of \\ interest is only on parts, No global\\  representation\end{tabular} &
			...
			\begin{tabular}[c]{@{}l@{}}Global channel extracts single \\ feature generalizing whole image,\\ \\ Local channel extract multiple\\  local features (logo, stickers),\\ \\ Attibute channel extracts \\ color, model, type\end{tabular} &
			\begin{tabular}[c]{@{}l@{}}Prons:\\ Extraction of inter and intra features,\\ Data augmentation with license plate \\ verification\\ \\ Cons:\\ Requires Data augmentation,\\ Effected by illuminations\end{tabular} &
